...
**6 July 2026**    
Together with Craig MacLean and Adam Mulkern (Oxford), Liam published an essay in *PLOS Biology* arguing that antibiotic resistance is often catalyzed by what we call 'resistance potentiators'. Introducing a new concept is always tricky, but we think that this one does useful work in uniting together an assortment of different mechanisms by which bacteria accelerate evolution in a trait-specific manner. Read the paper [here](https://doi.org/10.1371/journal.pbio.3003852).  
...
**12 June 2026**  
A pleasure to play a minor role in this paper from Jenny Readshaw (Durham) on DNA modification in a collection of environmental phages (originally collected by undergraduates!). This collaboration dates from Liam's time visiting Tim Blower's group. Congratulations to Jenny! Read the paper [here](https://doi.org/10.1128/aem.00810-26). 

### New preprint out on plasmid copy number
**11 June 2026**  
Plasmids can be present at different numbers of copy in a cell. This preprint addresses patterns in plasmid copy number, exploring the relationship between plasmid copy number and size and what it means. You can read more [here](https://doi.org/10.64898/2026.06.10.731345). 


### Strain-level profiling in metagenomes
**19 May 2026**  
Matthew Galbraith, a PhD student co-supervised by Liam, has published his first pre-print comparing different methods for recovering strain-level diversity in the gut microbiome. Congratulations to Matthew! The preprint is [here](https://doi.org/10.64898/2026.05.19.726160). 

### Hello world/Bristol!
**1 February 2026**  
The research group has officially started at Bristol! 
